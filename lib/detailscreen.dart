...
import 'package:interval_project/dateandtime.dart';
import 'package:interval_project/food.dart';
import 'package:interval_project/buynow.dart';
                        ...
                        child: Column(
                          ...
                          children: [
                            PlantFeature(
                              title: 'Type',
                              jewelleryfeature:
                                  _plantList[widget.plantId].jewelleryName,
                            ),
                          ],
                        ),
                      ))
...
class PlantFeature extends StatelessWidget {
  final String jewelleryfeature;
  final String title;

  const PlantFeature(
      {Key? key, required this.jewelleryfeature, required this.title})
      : super(key: key);
